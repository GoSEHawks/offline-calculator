...
#operations define
button_addition =Button(root, text= "+",padx=39,pady=20,command=buttonpp)
...
button_subtract =Button(root, text= "-",padx=41,pady=20,command=buttonnn)
button_multiply =Button(root, text= "*",padx=40,pady=20,command=buttonmm)
button_divide =Button(root, text= "/",padx=40,pady=20,command=buttondd)
